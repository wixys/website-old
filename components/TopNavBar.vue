        ...
        <section id="topbar" class="d-none d-lg-block">
            <div class="container-fluid clearfix">
                <div v-if="showWhatsappNumber">
                    <a :href="'https://wa.me/'+showWhatsappNumber" target="_blank" class="btn btn-brand float-right text-black ml-2" title="Enviar un whatsapp">
                        <font-awesome-icon :icon="['fab', 'whatsapp']" class="text-white" /> <span class="text-white">Whatsapp</span>
                    </a>
                </div>
                <div v-if="showPhoneNumber">
                    <a :href="'tel:'+showPhoneNumber" class="btn btn-brand float-right text-black" title="Llamar">
